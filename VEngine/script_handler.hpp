...
namespace RAGE
{
	...
	{
	public:
		class atDScriptObjectNode : public atDNode<void*>
		{
		};
	public:
		...
		virtual void add_object(void*, bool is_network, bool is_network_and_scriptcheck) = 0; // 10 (0x50)
	...
	public:
		...
		virtual void _0x38(void*) = 0;                                                     // 7 (0x38)
		...
		virtual void attach_thread(void*) = 0;                                             // 10 (0x50)

		// Detaches a script thread.
		virtual void detach_thread(void*) = 0;                                             // 11 (0x58)

		// Called when a player joins.
		virtual void on_player_join(void*) = 0;                                            // 12 (0x60)

		// Called when a player leaves.
		virtual void on_player_left(void*) = 0;                                            // 13 (0x68)
